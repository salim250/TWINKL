...
export const TranslationProvider = ({ children }: TranslationProviderProps) => {
    ...
    const translations = {
        fr: {
            ...
            // schedules page
            "schedules.title": "Calendrier des Cours",
            "schedules.subtitle": "Consultez les leçons à venir et téléchargez les supports de cours.",
            "schedules.addLesson": "Ajouter une leçon",
            "schedules.scheduleLesson": "Programmer une nouvelle leçon",
            "schedules.editScheduleLesson": "Modifier la leçon programmée",

            "schedules.form.title": "Titre de la leçon",
            "schedules.form.titlePlaceholder": "ex. Algèbre",
            "schedules.form.className": "Classe",
            "schedules.form.classPlaceholder": "ex. 10ème année A",
            "schedules.form.date": "Date",
            "schedules.form.startTime": "Heure de début",
            "schedules.form.endTime": "Heure de fin",
            "schedules.form.attachDocument": "Joindre un document (Optionnel)",
            ...
            "schedules.details.delete": "Supprimer la leçon",
            "schedules.details.edit": "Modifier la leçon",
        ...
        en: {
            ...
            // schedules page
            "schedules.title": "Class Calendar",
            "schedules.subtitle": "View upcoming lessons and download course materials.",
            "schedules.addLesson": "Add Lesson",
            "schedules.scheduleLesson": "Schedule a New Lesson",
            "schedules.editScheduleLesson": "Edit Scheduled Lesson",

            "schedules.form.title": "Lesson Title",
            "schedules.form.titlePlaceholder": "e.g. Algebra",
            "schedules.form.className": "Class Name",
            "schedules.form.classPlaceholder": "e.g. Grade 10 A",
            "schedules.form.date": "Date",
            "schedules.form.startTime": "Start Time",
            "schedules.form.endTime": "End Time",
            "schedules.form.attachDocument": "Attach Document (Optional)",
            ...
            "schedules.details.delete": "Delete Lesson",
            "schedules.details.edit": "Edit Lesson",
        ...
        ar: {
            ...
            "calendar.days.mon": "الإثنين",
            "calendar.days.tue": "الثلاثاء",
            "calendar.days.wed": "الأربعاء",
            "calendar.days.thu": "الخميس",
            "calendar.days.fri": "الجمعة",
            "calendar.days.sat": "السبت",

            // schedules page
            "schedules.title": "تقويم الدروس",
            "schedules.subtitle": "عرض الدروس القادمة وتنزيل مواد الدورة.",
            "schedules.addLesson": "إضافة درس",
            "schedules.scheduleLesson": "جدولة درس جديد",
            "schedules.editScheduleLesson": "تعديل درس مجدول",

            "schedules.form.title": "عنوان الدرس",
            "schedules.form.titlePlaceholder": "مثال: الجبر",
            "schedules.form.className": "اسم الصف",
            "schedules.form.classPlaceholder": "مثال: الصف 10 أ",
            "schedules.form.date": "التاريخ",
            "schedules.form.startTime": "وقت البدء",
            "schedules.form.endTime": "وقت الانتهاء",
            "schedules.form.attachDocument": "إرفاق مستند (اختياري)",
            ...
            "schedules.details.delete": "حذف الدرس",
            "schedules.details.edit": "تعديل الدرس",
