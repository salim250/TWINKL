...
export const TranslationProvider = ({ children }: TranslationProviderProps) => {
    ...
    const translations = {
        fr: {
            ...
            'career.form.fullName': 'Nom complet',
            'career.form.fullName.required': 'Le nom complet est requis.',
            'career.form.email': 'E-mail',
            'career.form.email.required': 'L\'email est requis.',
            'career.form.email.invalid': 'Adresse e-mail invalide.',
            'career.form.phone': 'Numéro de téléphone',
            'career.form.phone.required': 'Le numéro de téléphone est requis.',
            'career.form.phone.invalid': 'Numéro de téléphone invalide.',
            'career.form.position': 'Poste recherché',
            'career.form.position.required': 'Le poste recherché est requis.',
            'career.form.specialization': 'Spécialisation',
            'career.form.specialization.required': 'La spécialisation est requise.',
            'career.form.experience': 'Expérience',
            'career.form.experience.required': 'L\'expérience est requise.',
            'career.form.experience.notNegative': 'L\'expérience ne peut pas être négative.',
            'career.form.cv': 'CV *',
            'career.form.coverLetter': 'Lettre de motivation',
            'career.form.submit': 'Envoyer la candidature',
            'career.form.sending': 'Envoi en cours...',
            'career.form.success': 'Candidature envoyée avec succès !',
            'career.form.error': 'Échec de l’envoi de la candidature.',
            'career.form.placeholders.fullName': 'e.g. Ahmed Ben Ali',
            'career.form.placeholders.email': 'e.g. ahmed.benali@example.com',
            'career.form.placeholders.phone': 'e.g. +216 12 345 678',
            'career.form.placeholders.position': 'e.g. Enseignant de Mathématiques',
            'career.form.placeholders.specialization': 'e.g. Cambridge, IB',
            'career.form.placeholders.experience': 'e.g. 5',
            'career.form.documents.cvRequired': 'CV (PDF, DOC, DOCX)',
            'career.form.cv.required': 'Le CV est requis.',
            'career.form.documents.coverLetter': 'Lettre de motivation (optionnel)',
            "career.form.selectFile": "Choisir un fichier",
            "career.form.noFileChosen": "Aucun fichier choisi",
            ...
            "login.errors.invalidCredentials": "Identifiants de connexion invalides.",
            "login.errors.emailNotConfirmed": "E-mail non confirmé.",
            "login.errors.tooManyRequests": "Trop de tentatives. Veuillez réessayer plus tard.",
            "login.errors.userNotFound": "Utilisateur non trouvé.",
            "login.errors.generic": "Une erreur inattendue s'est produite. Veuillez réessayer plus tard.",
            ...
            "schedules.form.currentFile": "Document actuel",
            ...
            "schedules.editSuccess": "Leçon modifiée avec succès !",
            "schedules.addSuccess": "Leçon ajoutée avec succès !",
            "schedules.addError": "Échec de l'ajout de la leçon.",
            "schedules.editError": "Échec de la modification de la leçon.",
            ...
            'enroll.form.studentName.required': 'Le nom de l\'étudiant est requis.',
            'enroll.form.dob.required': 'La date de naissance est requise.',
            'enroll.form.dob.atLeastSix': 'L\'enfant doit avoir au moins 6 ans.',
            'enroll.form.gender.required': 'Le genre est requis.',
            'enroll.form.nationality.required': 'La nationalité est requise.',
            'enroll.form.parentName.required': 'Le nom du parent est requis.',
            'enroll.form.parentPhone.required': 'Le téléphone du parent est requis.',
            ...
            'enroll.form.parentEmail.invalid': 'Email du parent invalide.',
            'enroll.form.email.noRecipientFound': 'Aucun destinataire trouvé pour cet email.',
            ...
            "enroll.studentName": "Nom complet de l’étudiant",
            "enroll.studentNamePlaceholder": "e.g. Yasmine Ben Ali",
            "enroll.dob": "Date de naissance",
            "enroll.gender": "Genre",
            "enroll.male": "Masculin",
            "enroll.female": "Féminin",
            "enroll.nationality": "Nationalité",
            "enroll.nationalityPlaceholder": "e.g. Tunisienne",
            "enroll.parentName": "Nom du parent",
            "enroll.parentNamePlaceholder": "e.g. Fatma Ben Youssef",
            "enroll.parentPhone": "Téléphone du parent",
            "enroll.parentEmail": "Email du parent",
            "enroll.parentEmailPlaceholder": "parent@example.com",
            "enroll.program": "Choix du programme",
            "enroll.selectProgram": "Sélectionnez le système éducatif",
            "enroll.cambridge": "Système Cambridge International",
            "enroll.french": "Système français",
            "enroll.tunisian": "Système tunisien",
            "enroll.canadian": "Système canadien",
            "enroll.ib": "Baccalauréat International (IB)",
            "enroll.subjects": "Matières d’intérêt",
            "enroll.subjectError": "Veuillez sélectionner au moins une matière.",
            "enroll.subjectHint": "Vous pouvez sélectionner une ou plusieurs matières",
            "enroll.schedule": "Horaire préféré",
            "enroll.declaration": "Je confirme que toutes les informations fournies sont exactes et j’accepte les politiques de TWINKL Education",
            "enroll.submit": "Envoyer l’inscription",
            "enroll.sending": "Envoi en cours...",
            "enroll.success": "Inscription envoyée avec succès !",
            "enroll.error": "Échec de l’envoi de l’inscription.",
            "enroll.subjects.English": "Anglais",
            "enroll.subjects.Mathematics": "Mathématiques",
            "enroll.subjects.Sciences / Coordinated Combined Science": "Sciences / Sciences combinées coordonnées",
            "enroll.subjects.ICT": "Technologies de l’information et de la communication (TIC)",
            "enroll.subjects.Business Studies": "Études commerciales",
            "enroll.subjects.French": "Français",
            "enroll.subjects.Global Perspectives": "Perspectives globales",
            "enroll.subjects.Other": "Autre",
            ...
            'team.rim.description': 'Mme Rim Hana est une professeure d\'anglais et traductrice dévouée et professionnelle, dotée d\'une grande expertise dans l\'enseignement des langues et les méthodologies pédagogiques. Elle est titulaire d\'un master en anglais de communication et d\'une licence en littérature, civilisation et linguistique anglaises, tous deux obtenus à l\'ISLT. Outre son expérience d\'enseignement dans des centres de langues et des universités, elle possède une grande expérience de l\'enseignement en ligne et a enseigné avec succès l\'anglais en tant que première et deuxième langue, en suivant le programme de Cambridge. Ses cours interactifs sont adaptés aux élèves de tous niveaux et les aident à atteindre efficacement leurs objectifs d\'apprentissage linguistique.',
        ...
        en: {
            ...
            // Career Application Form
            'career.form.fullName': 'Full Name',
            'career.form.fullName.required': 'Full name is required.',
            'career.form.email': 'Email',
            'career.form.email.required': 'Email is required.',
            'career.form.email.invalid': 'Invalid email address.',
            'career.form.phone': 'Phone Number',
            'career.form.phone.required': 'Phone number is required.',
            'career.form.phone.invalid': 'Invalid phone number.',
            'career.form.position': 'Position Applied For',
            'career.form.position.required': 'Position applied for is required.',
            'career.form.specialization': 'Specialization',
            'career.form.specialization.required': 'Specialization is required.',
            'career.form.experience': 'Experience',
            'career.form.experience.required': 'Experience is required.',
            'career.form.experience.notNegative': 'Experience cannot be negative.',
            'career.form.cv': 'CV *',
            'career.form.coverLetter': 'Cover Letter',
            'career.form.submit': 'Submit Application',
            'career.form.sending': 'Sending...',
            'career.form.success': 'Application submitted successfully!',
            'career.form.error': 'Failed to submit application.',
            'career.form.placeholders.fullName': 'e.g. Ahmed Ben Ali',
            'career.form.placeholders.email': 'e.g. ahmed.benali@example.com',
            'career.form.placeholders.phone': 'e.g. +216 12 345 678',
            'career.form.placeholders.position': 'e.g. Math Teacher',
            'career.form.placeholders.specialization': 'e.g. Cambridge, IB',
            'career.form.placeholders.experience': 'e.g. 5',
            'career.form.documents.cvRequired': 'CV (PDF, DOC, DOCX)',
            'career.form.cv.required': 'CV is required.',
            'career.form.documents.coverLetter': 'Cover Letter (optional)',
            "career.form.selectFile": "Select file",
            "career.form.noFileChosen": "No file chosen",
            ...
            "login.errors.invalidCredentials": "Invalid login credentials.",
            "login.errors.emailNotConfirmed": "Email not confirmed.",
            "login.errors.tooManyRequests": "Too many requests.",
            "login.errors.userNotFound": "User not found.",
            "login.errors.generic": "An unexpected error occurred.",
            ...
            "schedules.form.currentFile": "Current File",
            ...
            "schedules.editSuccess": "Lesson edited successfully!",
            "schedules.addSuccess": "Lesson added successfully!",
            "schedules.addError": "Failed to add lesson.",
            "schedules.editError": "Failed to edit lesson.",
            ...
            'enroll.form.studentName.required': 'Student name is required.',
            'enroll.form.dob.required': 'Date of birth is required.',
            'enroll.form.dob.atLeastSix': 'Child must be at least 6 years old.',
            'enroll.form.gender.required': 'Gender is required.',
            'enroll.form.nationality.required': 'Nationality is required.',
            'enroll.form.parentName.required': 'Parent name is required.',
            'enroll.form.parentPhone.required': 'Parent phone number is required.',
            'enroll.form.parentEmail.required': 'Parent email is required.',
            'enroll.form.program.required': 'Program selection is required.',
            'enroll.form.declaration.required': 'You must accept the declaration to submit the enrollment.',
            'enroll.form.subjects.required': 'Please select at least one subject of interest.',
            'enroll.form.schedule.required': 'Schedule is required.',
            'enroll.form.subject.error': 'Please select at least one subject.',
            'enroll.form.parentPhone.invalid': 'Invalid parent phone number.',
            'enroll.form.parentEmail.invalid': 'Invalid parent email.',
            'enroll.form.email.noRecipientFound': 'No recipient found for this email.',
            'enroll.application.button': 'Enrollment Form',
            "enroll.studentName": "Student Full Name",
            "enroll.studentNamePlaceholder": "e.g. Yasmine Ben Ali",
            "enroll.dob": "Date of Birth",
            "enroll.gender": "Gender",
            "enroll.male": "Male",
            "enroll.female": "Female",
            "enroll.nationality": "Nationality",
            "enroll.nationalityPlaceholder": "e.g. Tunisian",
            "enroll.parentName": "Parent Name",
            "enroll.parentNamePlaceholder": "e.g. Fatma Ben Youssef",
            "enroll.parentPhone": "Parent Phone Number",
            "enroll.parentEmail": "Parent Email",
            "enroll.parentEmailPlaceholder": "parent@example.com",
            "enroll.program": "Program Selection",
            "enroll.selectProgram": "Select educational system",
            "enroll.cambridge": "Cambridge International",
            "enroll.french": "French System",
            "enroll.tunisian": "Tunisian System",
            "enroll.canadian": "Canadian System",
            "enroll.ib": "International Baccalaureate (IB)",
            "enroll.subjects": "Subjects of Interest",
            "enroll.subjectError": "Please select at least one subject.",
            "enroll.subjectHint": "You may select one or more subjects",
            "enroll.schedule": "Preferred Schedule",
            "enroll.declaration": "I confirm that all information provided is accurate and I agree to the policies of TWINKL Education",
            "enroll.submit": "Submit Enrollment",
            "enroll.sending": "Sending...",
            "enroll.success": "Application submitted successfully!",
            "enroll.error": "Failed to submit application.",
            "enroll.subjects.English": "English",
            "enroll.subjects.Mathematics": "Mathematics",
            "enroll.subjects.Sciences / Coordinated Combined Science": "Sciences / Coordinated Combined Science",
            "enroll.subjects.ICT": "ICT",
            "enroll.subjects.Business Studies": "Business Studies",
            "enroll.subjects.French": "French",
            "enroll.subjects.Global Perspectives": "Global Perspectives",
            "enroll.subjects.Other": "Other",
            ...
            'team.rim.description': 'Ms. Rim Hana is a dedicated and professional English teacher and translator with extensive expertise in language instruction and educational methodology. She holds a Master\'s Degree in English for Communication from ISLT and a Bachelor\'s Degree in English Literature, Civilization, and Linguistics from ISLT. In addition to teaching in language centers and universities, she has extensive experience in online teaching and has successfully taught English as both a first and second language following the Cambridge curriculum. Her interactive lessons are tailored to students across various proficiency levels, helping them achieve their language learning goals effectively.',
        ...
        ar: {
            ...
            // Career Application Form
            'career.form.fullName': 'الاسم الكامل',
            'career.form.fullName.required': 'الاسم الكامل مطلوب',
            'career.form.email': 'البريد الإلكتروني',
            'career.form.email.required': 'البريد الإلكتروني مطلوب',
            'career.form.email.invalid': 'البريد الإلكتروني غير صحيح',
            'career.form.phone': 'رقم الهاتف',
            'career.form.phone.required': 'رقم الهاتف مطلوب',
            'career.form.phone.invalid': 'رقم الهاتف غير صحيح',
            'career.form.position': 'الوظيفة المطلوبة',
            'career.form.position.required': 'الوظيفة المطلوبة مطلوبة',
            'career.form.specialization': 'التخصص',
            'career.form.specialization.required': 'التخصص مطلوب',
            'career.form.experience': 'الخبرة',
            'career.form.experience.required': 'الخبرة مطلوبة',
            'career.form.experience.notNegative': 'الخبرة لا يمكن أن تكون سلبية',
            'career.form.cv': ' *السيرة الذاتية',
            'career.form.coverLetter': 'رسالة التحفيز',
            'career.form.submit': 'إرسال الطلب',
            'career.form.sending': 'جاري الإرسال...',
            'career.form.success': 'تم إرسال الطلب بنجاح!',
            'career.form.error': 'فشل إرسال الطلب.',
            'career.form.placeholders.fullName': 'مثال: أحمد بن علي',
            'career.form.placeholders.email': 'مثال: ahmed.benali@example.com',
            'career.form.placeholders.phone': 'مثال: +216 12 345 678',
            'career.form.placeholders.position': 'مثال: معلم رياضيات',
            'career.form.placeholders.specialization': 'مثال: كامبريدج، البكالوريا الدولية',
            'career.form.placeholders.experience': 'مثال: 5',
            'career.form.documents.cvRequired': 'السيرة الذاتية (PDF, DOC, DOCX)',
            'career.form.cv.required': 'السيرة الذاتية مطلوبة',
            'career.form.documents.coverLetter': 'رسالة التحفيز (اختياري)',
            "career.form.selectFile": "اختر ملف",
            "career.form.noFileChosen": "لم يتم اختيار ملف",
            ...
            "logout.submit": "تسجيل الخروج",
            "login.errors.invalidCredentials": "البريد الإلكتروني أو كلمة المرور غير صحيحة.",
            "login.errors.emailNotConfirmed": "البريد الإلكتروني غير مؤكد.",
            "login.errors.tooManyRequests": "لقد قمت بمحاولات كثيرة. يرجى المحاولة مرة أخرى لاحقًا.",
            "login.errors.userNotFound": "المستخدم غير موجود.",
            "login.errors.generic": "حدث خطأ غير متوقع. يرجى المحاولة مرة أخرى لاحقًا.",
            ...
            "schedules.form.currentFile": "الملف الحالي",
            ...
            "schedules.editSuccess": "تم تعديل الدرس بنجاح!",
            "schedules.addSuccess": "تمت إضافة الدرس بنجاح!",
            "schedules.addError": "فشل في إضافة الدرس.",
            "schedules.editError": "فشل في تعديل الدرس.",
            ...
            'enroll.form.studentName.required': 'اسم الطالب مطلوب.',
            'enroll.form.dob.required': 'تاريخ الميلاد مطلوب.',
            'enroll.form.dob.atLeastSix': 'يجب أن يكون الطفل عمره 6 سنوات على الأقل.',
            'enroll.form.gender.required': 'الجنس مطلوب.',
            'enroll.form.nationality.required': 'الجنسية مطلوبة.',
            'enroll.form.parentName.required': 'اسم ولي الأمر مطلوب.',
            'enroll.form.parentPhone.required': 'رقم هاتف ولي الأمر مطلوب.',
            'enroll.form.parentEmail.required': 'بريد ولي الأمر مطلوب.',
            'enroll.form.program.required': 'اختيار البرنامج مطلوب.',
            'enroll.form.declaration.required': 'يجب أن توافق على الإعلان لتقديم التسجيل.',
            'enroll.form.subjects.required': 'يرجى اختيار مادة واحدة على الأقل من الاهتمام.',
            'enroll.form.schedule.required': 'الجدول الزمني مطلوب.',
            'enroll.form.subject.error': 'يرجى اختيار مادة واحدة على الأقل.',
            'enroll.form.parentPhone.invalid': 'رقم هاتف ولي الأمر غير صالح.',
            'enroll.form.parentEmail.invalid': 'بريد ولي الأمر غير صالح.',
            'enroll.form.email.noRecipientFound': 'لم يتم العثور على مستلم لهذا البريد الإلكتروني.',
            'enroll.application.button': 'نموذج التسجيل',
            "enroll.studentName": "الاسم الكامل للطالب",
            "enroll.studentNamePlaceholder": "مثال: ياسمين بن علي",
            "enroll.dob": "تاريخ الميلاد",
            "enroll.gender": "الجنس",
            "enroll.male": "ذكر",
            "enroll.female": "أنثى",
            "enroll.nationality": "الجنسية",
            "enroll.nationalityPlaceholder": "مثال: تونسي",
            "enroll.parentName": "اسم ولي الأمر",
            "enroll.parentNamePlaceholder": "مثال: فاطمة بن يوسف",
            "enroll.parentPhone": "رقم هاتف ولي الأمر",
            "enroll.parentEmail": "بريد ولي الأمر",
            "enroll.parentEmailPlaceholder": "parent@example.com",
            "enroll.schedule": "الجدول الزمني المفضل",
            "enroll.parentInfo": "اسم ولي الأمر ورقم الهاتف",
            "enroll.program": "اختيار البرنامج",
            "enroll.selectProgram": "اختر النظام التعليمي",
            "enroll.cambridge": "نظام كامبريدج الدولي",
            "enroll.french": "النظام الفرنسي",
            "enroll.tunisian": "النظام التونسي",
            "enroll.canadian": "النظام الكندي",
            "enroll.ib": "البكالوريا الدولية (IB)",
            "enroll.subjects": "المواد الدراسية",
            "enroll.subjectError": "يرجى اختيار مادة واحدة على الأقل.",
            "enroll.subjectHint": "يمكنك اختيار مادة واحدة أو أكثر",
            "enroll.declaration": "أؤكد أن جميع المعلومات المقدمة صحيحة وأوافق على سياسات TWINKL Education",
            "enroll.submit": "إرسال التسجيل",
            "enroll.sending": "جارٍ الإرسال...",
            "enroll.success": "تم إرسال الطلب بنجاح!",
            "enroll.error": "فشل في إرسال الطلب.",
            "enroll.subjects.English": "اللغة الإنجليزية",
            "enroll.subjects.Mathematics": "الرياضيات",
            "enroll.subjects.Sciences / Coordinated Combined Science": "العلوم / العلوم المدمجة المنسقة",
            "enroll.subjects.ICT": "تقنيات المعلومات والاتصالات",
            "enroll.subjects.Business Studies": "دراسات الأعمال",
            "enroll.subjects.French": "اللغة الفرنسية",
            "enroll.subjects.Global Perspectives": "وجهات نظر عالمية",
            "enroll.subjects.Other": "أخرى",
            ...
            'team.rim.description': 'السيدة ريم هانا هي معلمة ومترجمة لغة إنجليزية متفانية ومحترفة، تتمتع بخبرة واسعة في تدريس اللغات ومنهجيات التعليم. وهي حاصلة على درجة الماجستير في اللغة الإنجليزية للتواصل من معهد ISLT، ودرجة البكالوريوس في الأدب والحضارة واللغويات الإنجليزية من المعهد نفسه. وبالإضافة إلى عملها في التدريس بمراكز اللغات والجامعات، تتمتع بخبرة واسعة في التدريس عبر الإنترنت، وقد نجحت في تدريس اللغة الإنجليزية كلغة أولى وثانية وفقًا لمنهج كامبريدج. تم تصميم دروسها التفاعلية خصيصًا لتناسب الطلاب من مختلف مستويات الكفاءة، مما يساعدهم على تحقيق أهدافهم في تعلم اللغة بفعالية.',
